...
import bannerImg from "../../assets/academic-banner.jpg";
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 space-y-12">
        ...
        <div className="backdrop-blur-xl bg-white/60 border border-indigo-200 shadow-xl rounded-2xl p-8">
          <p className="text-gray-700 leading-[1.9] text-justify text-xl">
            Official institutional guide containing academic schedules and key academic dates
          </p>
          ...
          >
            <Download size={18} /> Download Academic Calendar (PDF)
          </motion.a>
        </div>
